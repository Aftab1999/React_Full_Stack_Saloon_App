                        ...
                        <div>
                            <Box sx={{ maxWidth: "100%", padding: 2 }}>
                                <ImageListItem sx={{
                                    ...
                                    <Grid container sx={{ display: "inline-block", justifyContent: "left", marginLeft: "10px", maxWidth: "100%" }}>
                                        <Grid item xs={12} sx={{ color: "white", maxWidth: "100%" }}>
                                            <Typography sx={{ color: "white", fontSize: "20px", maxWidth: "300px" }}>Collection Hair & Beard</Typography>
                                        </Grid>
                                        <Grid item xs={12} sx={{ color: "white", maxWidth: "400px" }}>
                                            <Typography sx={{ color: "#D4D4C3", fontSize: "14px", maxWidth: "80%" }}>Here Are Many Variations Of Passages Of Lorem Ipsum
                                                Avaialble, But The Majority Suffered</Typography>
                                        </Grid>
                                        <Grid item xs={12} sx={{ color: "white", maxWidth: "100%" }}>
                                            <Button sx={{ color: "white", border: "2px solid #E7A356", marginTop: "20px", fontSize: "14px", backgroundColor: "black", padding: "3px 8px" }} onClick={() => navigate("/seeallservices")}>See All Services</Button>
                                        </Grid>
                                    </Grid>
                                </ImageListItem>
